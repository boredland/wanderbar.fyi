...
export const de: Messages = {
  ...
  'condition.lightning': 'Trockene Blitze',
  ...
  'lightningBand.very low': 'sehr gering',
  'lightningBand.low': 'gering',
  'lightningBand.moderate': 'mäßig',
  'lightningBand.high': 'hoch',
  'lightningBand.very high': 'sehr hoch',
  'lightningBand.extreme': 'extrem',
  ...
  'settings.lightningFrom': 'Blitze ab',
