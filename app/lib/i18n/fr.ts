...
export const fr: Messages = {
  ...
  'condition.lightning': 'Foudre sèche',
  ...
  'lightningBand.very low': 'très faible',
  'lightningBand.low': 'faible',
  'lightningBand.moderate': 'modéré',
  'lightningBand.high': 'élevé',
  'lightningBand.very high': 'très élevé',
  'lightningBand.extreme': 'extrême',
  ...
  'settings.lightningFrom': 'Foudre à partir de',
