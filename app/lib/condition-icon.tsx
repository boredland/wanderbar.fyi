...
const PATHS: Record<Condition, string> = {
  ...
  lightning: 'M13 2 5 13h5l-1 9 8-11h-5l1-9zM3 20h3M18 20h3',
  ice: 'M7 14.5a4.5 4.5 0 0 1 .5-8.96 5.5 5.5 0 0 1 10.6 1.51A3.75 3.75 0 0 1 17.5 14.5M8 17.5l-1 2M15.5 17.5l-1 2M11.5 17.5v2.5m-1.5-1.5 1.5 1.5 1.5-1.5',
  coldwind: 'M3 7h9a2.5 2.5 0 1 0-2.5-2.5M3 11h7a2.5 2.5 0 1 1-2.5 2.5M17 10v10M13.5 12.5 17 16l3.5-3.5M14.5 8.5 17 6l2.5 2.5',
  deepsnow: 'M3 16.5h18M6 16.5c1.5-3 3.5-4.5 6-4.5s4.5 1.5 6 4.5M12 3v5M9.5 5l2.5 3 2.5-3M5 20h14'
}
