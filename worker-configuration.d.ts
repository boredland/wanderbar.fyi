/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1f2f16bcb351df5a062592ddba0d7d8)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	MET_USER_AGENT: "wanderbar.fyi/1.0 (https://wanderbar.fyi)";
	VAPID_SUBJECT: "mailto:admin@wanderbar.fyi";
	VAPID_PUBLIC_KEY: "BIV7EA_6_y2KIlijRyvNglkNZ1ISrdadrFDL8mdMy4m_x4mnz5ZyE76qv6oP2-C4c7kUfg3iJF3mi3qAIQd-52w";
	VAPID_PRIVATE_KEY: string;
	WAKER: DurableObjectNamespace<import("./dist/index").Waker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/index");
		durableNamespaces: "Waker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MET_USER_AGENT" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY">> {}
}
